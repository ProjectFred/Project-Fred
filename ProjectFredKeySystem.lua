-- Configuration
local GKey = "123" -- the actual key
local TextLabelText1 = "Project Fred" -- 1st line
local TextLabelText2 = "https://discord.gg/brxDytPxnP" -- 2nd line 
local TextFontAll = "Gotham" -- Font name

-- loadsting for script
local executeScript = loadstring(game:HttpGet(('https://raw.githubusercontent.com/ProjectFred/Project-Fred/refs/heads/main/PetsGo.lua'),true))
...
KeyMain.BackgroundColor3 = Color3.fromRGB(28, 29, 34)
...
KeyEnter.BackgroundColor3 = Color3.fromRGB(36, 37, 43)
...
Text1.BackgroundColor3 = Color3.fromRGB(74, 99, 135)
...
Text1.TextColor3 = Color3.fromRGB(74, 99, 135)
...
Text2.BackgroundColor3 = Color3.fromRGB(74, 99, 135)
...
Text2.TextColor3 = Color3.fromRGB(74, 99, 135)
